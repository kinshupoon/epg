# -*- coding:utf-8 -*-
#仅提供viu频道节目信息https://viu.tv/epg/96
# https://api.viu.tv/production/epgs/96
import requests, datetime, time, re, os
from utils.general import headers
from bs4 import BeautifulSoup as bs


def get_epgs_viu6(channel, channel_id, dt, func_arg):
  epgs = []
  msg = ''
  success = 1
  url = 'https://api.viu.tv/production/epgs/96'
  try:
...
#下载所有频道ID及名称
def get_channels_viu6():
  channel = {
      'name': 'ViuTV6',
      'id': ['viu6'],
      'url': 'https://viu.tv/epg/96',
      'source': 'viu6',
